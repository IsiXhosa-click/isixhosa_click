...
$(wasm_target)/isixhosa_wordle.wasm: wasm/Cargo.toml wasm/pwa/Cargo.toml $(wildcard wasm/pwa/src/**)
	cd wasm/wordle && cargo build $(cargo_flags)

$(wasm_target)/isixhosa_pwa.wasm: wasm/Cargo.toml wasm/wordle/Cargo.toml $(wildcard wasm/wordle/src/**) wasm/wordle/words.csv
